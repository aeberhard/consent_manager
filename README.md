...
```html
<link rel="stylesheet" href="/assets/addons/consent_manager/consent_manager_frontend.css?v=1614889336">
<script>var consent_manager_parameters = {initially_hidden: true, domain: "localhost", consentid: "604148a803b927.79055017", cachelogid: "53", version: "3", fe_controller: "/index.php"};</script>
<script src="/index.php?consent_manager_outputjs=1&amp;clang=1&amp;v=16148200841" id="consent_manager_script"></script>
```
